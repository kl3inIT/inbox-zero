---
title: 'Contributing'
description: 'Set up FocusMail for local development'
---

This guide is for developers who want to run FocusMail locally and contribute to the project.

<iframe
  width="560"
  height="315"
  src="https://www.youtube.com/embed/hVQENQ4WT2Y"
  title="Set up FocusMail locally"
  frameBorder="0"
