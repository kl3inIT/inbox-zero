...
Use the FocusMail API to manage emails and automation rules programmatically.

## Supported Email Providers

FocusMail supports integration with:
- **Gmail** (Google Workspace and personal accounts)
- **Outlook** (Microsoft 365 and personal accounts)

## Getting Started

To begin using the FocusMail API, you'll need to obtain an API key. Here's how:

1. Log in to your FocusMail account
