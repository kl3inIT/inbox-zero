...
description: 'Choose the right AWS deployment method for FocusMail'
---

There are three ways to deploy FocusMail on AWS. Choose the one that fits your team and infrastructure.
