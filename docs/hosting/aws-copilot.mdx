...
description: 'Deploy FocusMail to AWS using AWS Copilot and ECS Fargate'
---

Deploy FocusMail to AWS using AWS Copilot. The deployment uses Amazon ECS on Fargate.
...
- FocusMail repository cloned locally (run all commands from the repo root)
