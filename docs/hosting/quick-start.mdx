---
title: 'Quick Start'
description: 'Self-host FocusMail in under 5 minutes'
---

The fastest way to self-host FocusMail is with two commands:
...
Need to remove FocusMail or start fresh? See the [full cleanup guide](/hosting/troubleshooting#uninstalling--starting-over) in Troubleshooting.
