...
description: "Set up the Teams bot for FocusMail assistant chat."
---

# Microsoft Teams Integration Setup

This guide is for self-hosted deployments that want to enable Teams chat with the FocusMail assistant.

## What Teams currently supports

- AI assistant chat in **direct messages** with the FocusMail bot
...
```json
{
  ...
  "name": {
    "short": "FocusMail",
    "full": "FocusMail Assistant"
  },
  "description": {
    "short": "AI email assistant",
    "full": "Chat with your FocusMail AI assistant directly from Teams."
  },
  "icons": {
    "outline": "outline.png",
    "color": "color.png"
...
## 7. Connect a user account from FocusMail

Each FocusMail email account links to a Teams user via a connect code:

1. In FocusMail, go to **Settings** → **Connected Apps**
2. Click **Connect Teams**
3. Copy the generated command: `/connect <code>`
4. Open a DM with the FocusMail bot in Teams
5. Send the command
