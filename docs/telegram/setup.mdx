...
description: "Set up the Telegram bot for FocusMail assistant chat."
---

# Telegram Integration Setup

This guide is for self-hosted deployments that want to enable Telegram chat with the FocusMail assistant.
...
Set your bot's webhook to FocusMail:
...
## 5. Connect a user account from FocusMail

Each FocusMail email account links to a Telegram user via a connect code:
