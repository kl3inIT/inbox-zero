---
title: Introduction
description: 'Welcome to the FocusMail documentation'
---

<Info>
  FocusMail supports both **Google** and **Microsoft** email accounts.
</Info>

## Getting Started

Get started with FocusMail:
