...
The Call Webhook action lets you integrate email processing with other services. When a rule triggers, FocusMail sends the email data to your specified endpoint.
