...
The AI Chat is the primary way to interact with FocusMail. Tell it what you need in plain English and it handles the rest — no menus or settings pages required.
