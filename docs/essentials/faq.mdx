...
Answers to common questions about FocusMail.
...
Each email address you add must first sign up to FocusMail, and then you can add them to your account.
...
- Search for `FocusMail`, click on it, and then click `See Details`
...
- Find `FocusMail` in the list and click on it
- Click `Remove` to revoke access

If you don't see `FocusMail` in the list, it means the account is not connected to FocusMail.
...
1. **Use the [FocusMail Tabs Extension](/essentials/inbox-zero-tabs-extension)** - Our free browser extension adds custom tabs to Gmail, letting you organize emails by type (newsletters, receipts, to reply, etc.). It works great with our AI assistant which can automatically label emails for the tabs.

   ![FocusMail Tabs Extension](/images/extension.png)
