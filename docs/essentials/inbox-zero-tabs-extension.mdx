---
title: 'FocusMail Tabs Extension'
...
FocusMail Tabs is a free browser extension that adds custom tabs to Gmail. It helps you organize your inbox by creating tabs for different types of emails - similar to Superhuman's split inbox feature.
...
<Info>
  When used with [FocusMail's AI Assistant](/essentials/email-ai-personal-assistant), the extension becomes extra powerful. The AI can automatically categorize and label your emails, which then appear in the appropriate tabs without any manual setup.
</Info>
...
[Get FocusMail Tabs Extension](https://go.getinboxzero.com/extension)

Works with Chrome, Brave, Arc, Edge, Opera, and other Chromium-based browsers.

### Firefox
[Get FocusMail Tabs for Firefox](https://go.getinboxzero.com/firefox)
