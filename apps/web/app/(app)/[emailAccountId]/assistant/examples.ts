    ...
    designer: {
      ...
      promptArray: processPromptsWithTerminology(
        [
          ...
          "Gắn nhãn email từ Dribbble, Behance và các trang cảm hứng thiết kế khác là @[Inspiration] rồi lưu trữ",
    ...
    sales: {
      ...
      promptArray: processPromptsWithTerminology(
        [
          ...
          "Nếu ai đó hỏi về giá cho doanh nghiệp, hãy soạn bản nháp hỏi về quy mô công ty và nhu cầu của họ",
